...
import com.dsi3.api_productos.mapper.ClienteMapper;
import com.dsi3.api_productos.model.dto.ClienteRequestDTO;
import com.dsi3.api_productos.model.dto.ClienteResponseDTO;
import com.dsi3.api_productos.repository.InterfaceClienteRepository;
import com.dsi3.api_productos.service.interfaces.InterfaceClienteService;
...
public class ClienteService implements InterfaceClienteService {
    ...
    public List<ClienteResponseDTO> findAll(String busqueda) {
        List<com.dsi3.api_productos.model.entity.Cliente> clientes =
