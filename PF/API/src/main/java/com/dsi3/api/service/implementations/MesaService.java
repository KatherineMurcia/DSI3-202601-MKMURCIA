...
import com.dsi3.api.repository.InterfaceMesaRepository;
import com.dsi3.api.repository.InterfacePedidoRepository;
import com.dsi3.api.service.interfaces.InterfaceMesaService;
...
public class MesaService implements InterfaceMesaService {
    ...
    public List<MesaResponseDTO> findAll(String estado) {
        List<?> source = (estado != null && !estado.isBlank())
                ...
                : mesaRepo.findAll();
        return ((List<com.dsi3.api.model.entity.Mesa>) source)
